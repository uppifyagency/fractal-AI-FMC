...
The rest of the paper is organized as: background (§2); contribution 1, $\alpha_{\rm eff}$ (§3); contribution 2, the Moran/WF stationary law (§4); contribution 3, the magic-6 transient (§5); the synthesis on multiplicative-tiered shaping (§6); limitations and open problems, including the internal tension between §3 and §4 (§7–§8); references (§9).
