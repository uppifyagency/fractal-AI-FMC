...
| [`09_chaos_order_frontier_formalization.md`](09_chaos_order_frontier_formalization.md) | Formalizzazione della frontiera caos/ordine (Congettura B / discrepanza D3 di CLAUDE.md). Downgrade della "terza legge universale" a *diagnostica di reward* testabile sull'esponente di Lyapunov dello swarm $\lambda_1$; **falsificazione** di $\Psi_3=b_{\text{eff}}$ come statistica di frontiera (transitorio WF senza punto fisso + spazio-etichette monotonamente contrattivo); ipotesi competitive H-B1a/b/c vs nulla. **H-B1a eseguita (2026-05-21, [`work/13_chaos_order/`](../13_chaos_order/HB1A_RESULT.md)): λ₁ non scale-free → anche Ψ₁ compromessa, H-B4 guadagna terreno.** | ✅ scritto | n/a (formalizzazione originale; edge-of-chaos: Langton 1990, Bertschinger & Natschläger 2004) |
...
9. **09 — Frontiera caos/ordine** (✅ scritto). Formalizza la Congettura B e chiude la discrepanza D3; falsifica una candidata statistica di frontiera ($b_{\text{eff}}$) per propagazione corretta della falsificazione di Congettura A. Lavoro originale, non derivato.
