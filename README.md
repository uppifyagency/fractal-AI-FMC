...
- Canonical math is now [`docs/MATH_CANON.md`](docs/MATH_CANON.md) **v0.7.6** — 6 definitions, 3 theorems, **5 falsifiable conjectures (A–E)**, each with empirical-verification status.
